...
public class Father implements User {
  ...
  public Father(TimeAndLocation timeAndLocation, Vaccine vaccine) {
	  this.timeAndLocation.date = timeAndLocation.date;
	  this.timeAndLocation.location = timeAndLocation.location;
	  this.timeAndLocation.timeSlot = timeAndLocation.timeSlot;
...
public void setUserDetails(String name, int age, TimeAndLocation timeAndLocation) {
	...
	this.timeAndLocation.location = timeAndLocation.location;
	this.timeAndLocation.timeSlot = timeAndLocation.timeSlot;
	System.out.println(this.name+this.age+this.timeAndLocation.date);
	
}
@Override
public void setAppointment() {
	// TODO Auto-generated method stub
	System.out.println("Hello "+this.name+" your appointment has been fixed for"+this.vaccine+" on"+this.timeAndLocation.timeSlot+" at"+this.timeAndLocation.location+" on"+this.timeAndLocation.date);
